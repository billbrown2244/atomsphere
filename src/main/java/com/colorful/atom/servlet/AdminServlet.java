...
public class AdminServlet extends HttpServlet {
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        try{
            atomConfigFile = new File(config.getInitParameter("configPath"));
            
            //if the file exists decode it.
            //and write out the files to their locations.
    ...
    public void doGet( HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException
    {
        ...
        String docRoot = request.getRemoteHost()+":8080/mediafeed";
        out.println("Document Root = "+docRoot);
