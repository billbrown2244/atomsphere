...
/**
 * This class reads and writes atom documents to and from xml files, objects or Strings.
 * It contains all of the factory methods for building immutable copies of the object elements.
 * @author Bill Brown
 *
 */
...
FeedDoc.writeFeedDoc(writer,myFeed,null,null);	
     ...
     * @param version the xml version (default is 1.0)
     * @throws Exception thrown if the feed cannot be written to the output 
     * see <code>writeFeedDoc(XMLStreamWriter output,Feed feed,String encoding,String version)</code>
	 */
     ...
     * see <code>readFeedToString(Feed feed, String xmlStreamWriter)</code>
     */
	...
	private static void writeEntryOutput(Entry entry, XMLStreamWriter writer, String encoding, String version)
	...
	private static void writeFeedOutput(Feed feed
			, XMLStreamWriter writer
			,String encoding
			, String version)
