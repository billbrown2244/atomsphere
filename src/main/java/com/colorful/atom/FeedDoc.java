...
public class FeedDoc {
    ...
    /**
     * the Atomsphere library version in the form of a generator element. 
     * This element is output for all feeds that are generated by Atomsphere.
     */
    public static final Generator atomsphereVersion = FeedDoc.buildGenerator(attributes,"Atomsphere");
